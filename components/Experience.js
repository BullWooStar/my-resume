    ...
    <div className={styles.experienceBox}>
      ...
      <div>
        ...
        <div className={styles.contentBox}>
          ...
          <ul>
            <li>
              Vite를 사용해서 번들링을 함으로써 더 빠른 빌드속도를 만들었습니다.
            </li>
            <li>
              서버데이터를 많이 사용하는 관리자 페이지의 특성상 React Query를
              사용함으로써 비동기코드를 간소화 시키고 비동기데이터를 효율적으로
              관리하였습니다.
            </li>
            <li>
      ...
      <div className={styles.experienceContent}>
        ...
        <div className={styles.contentBox}>
          ...
          <p>
            ...
            프론트엔드에서 UI/UX를 구성하였고 백엔드 엔지니어와의 API설계를 통해
            회원정보에 맞는 대출상품을 추천받을 수 있고 이를 장바구니에 담아
            구매할 수 있는 웹 어플리케이션을 만들었습니다.
          </p>
        </div>
        <div className={styles.contentBox}>
          <h3>What did i do.</h3>
          ...
          <ul>
            <li>
              ...
              방향성을 잡고 실력이 부족한 팀원이 있으면 도와주고 북돋아가며 팀의
              균형을 유지해나가려고 노력했습니다.
            </li>
            <li>
              팀으로 협업을 할때의 컨벤션에 대해 많은 생각을 했습니다.
              Conventional Commit 메시지 규칙을 사용하였고 pull request
              template을 만들어 request 요청을 하게 하였으며 팀원 전원의 리뷰를
              받아야 팀장이 최종 머지를 하는 방식을 사용하였습니다.
            </li>
            <li>
          ...
          <p>[기술적 경험]</p>
          <ul>
            <li>Redux Toolkit을 사용해서 상태관리를 쉽게 할 수 있었습니다.</li>
            <li>
