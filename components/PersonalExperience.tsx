  ...
  return (
    <div className={styles.personalExperienceBox}>
      <FadeInSection>
        ...
        <div>
          <h2>
            프론트엔드 개발을 위한 자바스크립트 스터디 (Programmers school)
          </h2>
          <p>2022.09 ~ 2022.10 </p>
          <p>
            GitHub :&nbsp;
          ...
          <ul>
            ...
            <li>
              ...
              바닐라 자바스크립트로 구현해보면서 많은 공부가 되었습니다. 이에
              더해 event bubbling/delegation, debounce 같은 개념들도 배우고
              미션에 적용시켜보았습니다.
            </li>
            <li>
      ...
      <FadeInSection>
        <div className={styles.experienceContent}>
          ...
          <ul>
            <li>
              매주 현업개발자와의 개인 멘토링 시간을 통해 제가 모르는 것,
              어려웠던 것들에 대한 질의응답시간을 가지고 따로 미션을 받았습니다.
            </li>
            <li>
